<template>
    <div class="w-full md:w-11/12 flex md:flex-row flex-col item-center justify-center rounded-lg mt-10 h-auto mx-auto">
        <div class="w-11/12 md:w-4/5 mx-auto md:mx-0 order-last md:-order-1 bg-white pb-2 rounded-lg">
               ...
               <div v-for="(order,index) in $store.state.cart.items" :key="index" class="flex item-center justify-between px-2 pt-2">
                   ...
                   <div class="border border-orange-200 flex py-1 px-2 w-full h-28 bg-white rounded-lg">
                       ...
                       <img 
                            class="w-32 md:w-28 h-24 mt-1 md:mt-0 md:h-full rounded-lg border border-gray-300" 
                        ...
                        <div class="flex flex-col justify-between px-4 py-1 leading-normal">
                            ...
                            <div class="flex">
                                <!-- ------------------------------ -->
                                    <button @click="deleteCart(order.product[0].id)" class="btn-distroy tooltip md:mt-0 mt-1">
                                        ...
                                        <span class="tooltiptext px-2">retirer</span>
                                    </button>
                                <!-- --------------------------------- -->
                            </div>
                        </div>
        ...
        <div class="w-11/12 mx-auto md:mx-0 md:w-48 mb-3 md:mb-0 bg-white h-56 md:ml-8 rounded-lg">
               <div class="border border-l-0 border-r-0 border-t-0 border-b-gray-300 p-2">
               ...
               <div class="flex p-1">
                ...
                <div class="w-11/12 mx-auto my-2">
                   ...
                   <button @click="loginToCommand()" v-if="$store.state.id_user_login==0" class="w-full p-3 bg-white border hover:font-bold hover:border-gray-600 text-xs whitespace-nowrap rounded-lg text-gray-500 remark-cities">COMMANDER ({{$store.state.tottalPrice}} DHS)</button>
                </div>  
    ...
    methods : {
        loginToCommand(){
            this.$swal({
                icon: 'error',
                title: 'Invalid...',
                text: 'connecter pour passer command votre commande !',
            })
        },
