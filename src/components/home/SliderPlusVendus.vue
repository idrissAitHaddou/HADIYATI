    ...
    <div>
            ...
            <div id="controls-carousel" class="relative" data-carousel="static">
                ...
                <div class="overflow-hidden relative h-80 rounded-lg">
                    ...
                    <!-- <img src="../../assets/images/bestBirthday.svg" class="block absolute top-1/2 left-1/2 w-full -translate-x-1/2 -translate-y-1/2" alt="..."> -->
                      <div class="grid grid-cols-4 gap-2 h-full w-full px-5 py-3">
                          
                            <div class="max-w-sm bg-white rounded-lg shadow-md">
                                
                                    <div class="relative">
                                        <a href="#" class="">
                                          <img class="rounded-t-lg w-full" src="../../assets/images/bestBirthday.svg" alt="product image">
                                        </a>  
                                         <a href="#"> 
                            ...
                            <div class="max-w-sm bg-white rounded-lg shadow-md">
                                    ...
                                    <div class="relative">
                                        ...
                                        <a href="#">  
                                            <span class="absolute top-0 right-0 h-11 w-11 rounded-bl-full bg-white pl-1">
                                                <svg class="h-6 w-6 mx-auto mt-1" xmlns="http://www.w3.org/2000/svg" fill="#C5AAAC" viewBox="0 0 512 512"><path d="M0 190.9V185.1C0 115.2 50.52 55.58 119.4 44.1C164.1 36.51 211.4 51.37 244 84.02L256 96L267.1 84.02C300.6 51.37 347 36.51 392.6 44.1C461.5 55.58 512 115.2 512 185.1V190.9C512 232.4 494.8 272.1 464.4 300.4L283.7 469.1C276.2 476.1 266.3 480 256 480C245.7 480 235.8 476.1 228.3 469.1L47.59 300.4C17.23 272.1 .0003 232.4 .0003 190.9L0 190.9z"/></svg>
                                            </span>
                                        </a>
                                    </div>
                    ...
                    <img src="../../assets/images/bestCopines.svg" class="block absolute top-1/2 left-1/2 w-full -translate-x-1/2 -translate-y-1/2" alt="...">
                    </div>

                    <div class="hidden duration-700 ease-in-out absolute inset-0 transition-all transform" data-carousel-item="">
                    <img src="../../assets/images/bestMariage.svg" class="block absolute top-1/2 left-1/2 w-full -translate-x-1/2 -translate-y-1/2" alt="...">
                    </div>
