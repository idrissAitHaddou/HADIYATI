<template>
    <div class="mt-14">
        <h1 class="title-cities w-4/5 mx-auto md:text-4xl text-lg">Les meilleurs cadeaux sont chers</h1>
        <p class="remark-cities w-4/5 mx-auto md:text-sm text-xs">Nous vous proposons les cadeaux les plus vendus</p>
        <div class="w-4/5 mx-auto my-4 grid grid-cols-1 md:grid-cols-4 gap-4">
                <div v-for="(product , index) in products" :key="index" class="">
                       
                        <div class="card mx-auto" v-bind:style="addBackgroundLiner(product[0].background)">
                                        <div class="card-img">
                                                <a :href="setRouteCart(product[0].id)"><img
                                                    class="w-full h-full"
                                        ...
                                        <div class="card-info">
                                            <p class="text-body font-mono flex flex-wrap">{{product[0].name.substr(0,18)}}...</p>
                                        </div>
                                        <div class="card-footer">
                                        <span class="text-body font-mono font-bold mt-1">{{product[0].price}} DH</span>
                                        <a :href='setRouteCart(product[0].id)'>
                                        ...
                                        <a :href='setRouteCart(product[0].id)'> <div class="card-button">
