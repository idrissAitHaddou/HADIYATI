<template>
    <div>
            ...
            <h1 class="text-center font-medium my-10 text-xl">Meilleur sous 50 MAD</h1>
                    ...
                    <div class="duration-700 ease-in-out absolute inset-0 transition-all transform -translate-x-full z-10" data-carousel-item="">
                      <div class="grid grid-cols-4 gap-2 h-full w-full px-5 py-3">
                            ...
                            <div class="max-w-sm bg-white rounded-lg shadow-md">
                                    ...
                                    <div class="relative">
                                        <a href="#" class="">
                                          <img class="rounded-t-lg w-full" src="../../assets/images/MilleurProduct.svg" alt="product image">
                                        </a>  
                                         <a href="#"> 
