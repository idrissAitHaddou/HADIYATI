                    ...
                    <div v-for="item in 2" :key="item" class="duration-700 ease-in-out absolute inset-0 transition-all transform -translate-x-full z-10" data-carousel-item="">
                      <div class="grid grid-cols-4 gap-2 h-full px-5 py-3">
                           ...
                           <template v-if="item==1">
                               <div v-for="product in firstMFour" :key="product" class="max-w-sm bg-white rounded-lg shadow-md">
                           ...
                           <template v-else-if="item==2">
                               <div v-for="product in scondMFour" :key="product" class="max-w-sm bg-white rounded-lg shadow-md">
        ...
        async getProductsPlus(){
            ...
            axios.get('http://localhost/hadiyati/cheap-products').then((response) => {
                    ...
                    for(let i=0 ; i<response.data.length ; i++){
                        if(i<4){
                            this.firstMFour.push(response.data[i])
                        }
                        if(i>3){
                            this.scondMFour.push(response.data[i])
                        }
                    }
