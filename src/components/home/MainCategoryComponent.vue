  ...
  <div class="flex flex-col md:flex-row w-4/5 mx-auto justify-around">
      <button class="m-2">
          <a href="#" class="flex items-center p-3 pr-10 text-base font-bold text-gray-900 bg-gray-50 rounded-lg hover:bg-gray-100 group hover:shadow dark:bg-gray-600 dark:hover:bg-gray-500 dark:text-white">
              ...
              <span class="flex-1 ml-3 whitespace-nowrap">Livraison gratuite</span>
          </a>
      </button>
      <button class="m-2">
          <a href="#" class="flex items-center p-3 pr-10 text-base font-bold text-gray-900 bg-gray-50 rounded-lg hover:bg-gray-100 group hover:shadow dark:bg-gray-600 dark:hover:bg-gray-500 dark:text-white">
              ...
              <span class="flex-1 ml-3 whitespace-nowrap">Retour</span>
          </a>
      </button>
      <button class="m-2">
          <a href="#" class="flex items-center p-3 pr-10 text-base font-bold text-gray-900 bg-gray-50 rounded-lg hover:bg-gray-100 group hover:shadow dark:bg-gray-600 dark:hover:bg-gray-500 dark:text-white">
              ...
              <span class="flex-1 ml-3 whitespace-nowrap">Support en ligne</span>
          </a>
      </button>
      <button class="m-2">
          <a href="#" class="flex items-center p-3 pr-10 text-base font-bold text-gray-900 bg-gray-50 rounded-lg hover:bg-gray-100 group hover:shadow dark:bg-gray-600 dark:hover:bg-gray-500 dark:text-white">
              <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="yellow" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                <path stroke-linecap="round" stroke-linejoin="round" d="M17 9V7a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2m2 4h10a2 2 0 002-2v-6a2 2 0 00-2-2H9a2 2 0 00-2 2v6a2 2 0 002 2zm7-5a2 2 0 11-4 0 2 2 0 014 0z" />
              </svg>
              <span class="flex-1 ml-3 whitespace-nowrap">Paiement flexible</span>
          </a>
      </button>
  </div>
</template>
...
<script>
export default {
  name: "mainCategoryComponent.vue",
  components: {},
};
</script>
