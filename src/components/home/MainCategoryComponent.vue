  ...
  <div class="flex flex-col md:flex-row w-4/5 mx-auto justify-around">
      <button class="m-2">
          <a href="#" class="flex items-center p-3 pr-10 text-base font-bold text-gray-900 bg-gray-50 rounded-lg hover:bg-gray-100 group hover:shadow dark:bg-gray-600 dark:hover:bg-gray-500 dark:text-white">
              ...
              <span class="flex-1 ml-3 whitespace-nowrap">Free shipping</span>
          </a>
      </button>
      <button class="m-2">
          <a href="#" class="flex items-center p-3 pr-10 text-base font-bold text-gray-900 bg-gray-50 rounded-lg hover:bg-gray-100 group hover:shadow dark:bg-gray-600 dark:hover:bg-gray-500 dark:text-white">
      ...
      <button class="m-2">
          <a href="#" class="flex items-center p-3 pr-10 text-base font-bold text-gray-900 bg-gray-50 rounded-lg hover:bg-gray-100 group hover:shadow dark:bg-gray-600 dark:hover:bg-gray-500 dark:text-white">
              ...
              <span class="flex-1 ml-3 whitespace-nowrap">Online Support</span>
          </a>
      </button>
      <button class="m-2">
          <a href="#" class="flex items-center p-3 pr-10 text-base font-bold text-gray-900 bg-gray-50 rounded-lg hover:bg-gray-100 group hover:shadow dark:bg-gray-600 dark:hover:bg-gray-500 dark:text-white">
              ...
              <span class="flex-1 ml-3 whitespace-nowrap">Flexible Payment</span>
          </a>
      </button>
  </div>
</template>
