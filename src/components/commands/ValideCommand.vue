<template>
    ...
    <span class="remark-cities w-11/12 flex item-center text-xs text-gray-500 justify-start mt-4 mx-auto">
    ...
    <div class="w-11/12 flex flex-col item-center bg-white border rounded-lg mt-2 h-96 mx-auto">
        <div class="flex item-center justify-between border border-l-0 border-r-0 border-t-0 border-b-gray-300 w-full h-10 p-2">
            ...
            <div class="pb-1">
                <router-link to="/">
                   <button class="remark-cities ml-3 text-md text-main-color mr-6"> Fin </button>
                </router-link>
            </div>
        </div>
        <div class="flex item-center justify-between p-4">

            <div class="mt-3 w-4/5 h-64 relative">
                 <img class="absolute top-10 right-52" width="200" height="200" src="../../assets/images/success.png" alt="">
            </div>
