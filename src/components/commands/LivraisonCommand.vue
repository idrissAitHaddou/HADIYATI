<template>
    ...
    <div class="w-11/12 flex flex-col item-center bg-white border rounded-lg mt-2 h-auto md:h-96 mx-auto">
        <div class="flex item-center justify-between border border-l-0 border-r-0 border-t-0 border-b-gray-300 w-full h-auto md:h-10 p-2">
            ...
            <div class="pb-1">
                <button @click="validTypePayment()" class="remark-cities cssbuttons-io-button md:-mt-1 mt-2"> Suivant
                    <div class="icon">
        ...
        <form action="">
        <div class="flex md:flex-row flex-col item-center justify-between p-4">

                    <div class="w-full md:w-1/2 mt-3 border border-t-0 border-l-0 border-b-0 mr-5">
